...
class HunyuanVideoTransformer3DModelPacked(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def process_input_hidden_states(
        ...
        print('hidden_states shape start', hidden_states.shape)
        ...
        print('Rope freqs shape start', rope_freqs.shape)
        rope_freqs = rope_freqs.flatten(2).transpose(1, 2)
        print('Rope freqs shape mid', rope_freqs.shape)
        print('hidden_states shape mid', hidden_states.shape)
        ...
        print('Rope freqs shape concat', rope_freqs.shape)
        print('hidden_states shape concat', hidden_states.shape)
